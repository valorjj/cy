					...
					<div class="col-md-9" style="overflow: auto; height: 500px;">
						<div style="overflow: auto; height: 500px;">
							<form
								...
								<input type="hidden" name="oldphoto" value="<%=gallery.getPhoto()%>"> <!-- 첨부파일 변경이 없을 경우 기존파일불러오기 -->
							제목 : <input class="form-control" type="text" name="title" value="<%=gallery.getTitle()%>"> <br>
							내용 : <textarea class="form-control" rows="10" cols="20" name="content"><%=gallery.getContent()%></textarea> <br>
							첨부파일 : <input type="file" name="photo"> <%=gallery.getPhoto()%> <br>
