				...
				<div id="" class="tab-content current no-gutters"
					...
					<div class="container">
						<div class="row ">
							<div class="col-md-4 pl-5">
								<img src="../../../upload/<%=user.getUser_pic()%>"
									class="img-thumbnail" style="max-width: 80%;">
							</div>
							...
							<form
								...
								<div>
									...
									<div class="form-contorl" align="right">
										<input class="my-2" type="submit" value="작성">
									</div>
								</div>
							</form>
						</div>
						...
						<div class="container">
							...
							<div class="row form-control" style="width: 876px;">
							...
							%>
							<div class="row">
								<div class="d-flex justify-content-end my-2 col-md-4 offset-8">
									<div class="col-md-5 ">
									...
									<div class="col-md-5 ">
										<a
											href="../../../controller/mypage/visitor/deleteLogController.jsp?visitor_no=<%=visitor.getVisitor_no()%>&userNum=<%=visitor.getUser_no()%>">
					...
					<!-- 페이징 -->
					<div class="row">
						<div class="col-md-3 offset-5 my-3">
							<ul class="pagination">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h6 class="modal-title" id="exampleModalLabel">
						no : <span id="no"></span> 작성자 : <span id="writer"></span> 작성일 : <span
							id="date"></span>
					</h6>
