				...
				<form action="../../controller/user/signUpController.jsp"
					...
					<div class="form-check">
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="genderCheck"
								id="genderCheck1" value="M" onchange="signUpFormCheck();" /> <label
								for="genderCheck1">남성</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="genderCheck"
								id="genderCheck2" value="F" onchange="signUpFormCheck();" /> <label
					...
					<div class="form-group">
						...
						<label for="">나이</label> <select name="signAge" id="signAge"
							class="custom-select" onchange="signUpFormCheck();">
...
/* 		function signUpCheck(){ 
		...
		function signUpFormCheck() {
		      ...
		      //파일유무
		      // image 형식의 파일만 검사하는 유효성 검사를 나중에 추가하겠습니다. 
 		      if (signpic == "") {
