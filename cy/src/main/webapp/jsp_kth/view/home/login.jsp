        ...
        <div class="container">
            <div class="row col-12 d-flex flex-column">
                <ul class="d-flex my-2">
                    <li class="mx-3 "><a href="home.jsp">홈</a></li>
                    <li class="mx-3 active" style="border-bottom: solid 1px #000;"><a href="login.jsp">로그인</a></li>
                </ul>
                ...
                <div class="row login col-12 border">
                    <div class="col-6">
                        ...
                        <div class="row  col-12">
                            <form class="col-9 d-flex flex-column justify-content-center" action="">
                                ...
                                <input class="my-2" type=" password" style="width: 100%;" placeholder="비밀번호를 입력해주세요.">
                            </form>
                            ...
                            <div class="mt-1 d-flex flex-column col-12">
                                <div class="my-1 d-flex justify-content-between ">
                                    ...
                                    <a href="/signup.jsp"> <button type="button" class="btn btn-outline-warning"
                    ...
                    <div class="col-6" style="position: relative;">
                        ...
                        <div class="text-center">
                            <img src="../../img/3.login.png" alt="" style="width: 100%; height: 100%;">
                        </div>
